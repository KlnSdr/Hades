...
@RegisterFor(SystemInfoUpdate.class)
public class SystemInfoUpdate implements Update {
    private final GroupService groupService;

    @Inject
    public SystemInfoUpdate(GroupService groupService) {
    ...
    private List<Permission> buildPermissions(UUID groupId) {
        ...
        permission.setRoute("/systeminfo");
    ...
    @Override
    public int getOrder() {
        return UpdateOrder.SYSTEM_INFO_PERMISSION.getOrder();
    }
}
